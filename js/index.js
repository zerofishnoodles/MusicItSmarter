$(function()
{
    ...
    var musicImgsData0 = ['img/bg.jpg','img/bg1.jpg']    // 图片地址数组
    var musicNameData0 = ['complicated','red'];                   // 歌曲名数组
    var artistNameData0 = ['lavigne','swift']            // 创作歌手数组
    var musicUrls0=['../../mp3/music(1).mp3','mp3/music(2).mp3'];// 歌曲mp3数组
    
    var musicImgsData1 = ['img/bg.jpg','img/bg1.jpg']    // 图片地址数组
    var musicNameData1 = ['sunshine','打上花火'];                   // 歌曲名数组
    var artistNameData1 = ['bwo','daoko']            // 创作歌手数组
    var musicUrls1=['mp3/music(3).mp3','mp3/music(4).mp3'];
    
    var musicImgsData2 = ['img/bg.jpg','img/bg1.jpg']    // 图片地址数组
    var musicNameData2 = ['光年之外','后会无期'];                   // 歌曲名数组
    var artistNameData2 = ['邓紫棋','邓紫棋']            // 创作歌手数组
    var musicUrls2=['mp3/music(5).mp3','mp3/music(6).mp3']; 
    
    var musicImgsData3 = ['img/bg.jpg','img/bg1.jpg']    // 图片地址数组
    var musicNameData3 = ['魔鬼','泡沫'];                   // 歌曲名数组
    var artistNameData3 = ['邓紫棋','邓紫棋']            // 创作歌手数组
    var musicUrls3=['mp3/music(7).mp3','mp3/music(8).mp3']; 
